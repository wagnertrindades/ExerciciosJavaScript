...
botao.addEventListener("click", function(event){
	...
	//Caso nenhum campo tenha valor vazio
	if( campoNome.value != "" && campoPeso.value > 0 && campoAltura.value > 0){
		...
		var digiteInformacoes = "<p>Erro! É necessário que todos os valores sejam preenchidos para que possa cadastrar um novo paciente.</p>"

		var formulario = document.querySelector("form");

		formulario.innerHTML += digiteInformacoes;
